 ...
 */
final class Version20190708090157 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE material (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, serial_number VARCHAR(255) NOT NULL, INDEX IDX_7CBE759512469DE2 (category_id), INDEX IDX_7CBE75959D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
